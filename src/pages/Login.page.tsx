import { Anchor, Button, Center, Checkbox, Container, Group, Input, PasswordInput, Stack, Text, Title } from "@mantine/core";
        ...
        <Stack px={"20px"} py={"40px"}>
          ...
          <Container w={"100%"}>
            <Stack>
              ...
              <PasswordInput size="xs" placeholder="Password" leftSection={<IconLockPassword size={16} />}/>
            </Stack>
          </Container>
          ...
          <Container w={"100%"}>
            <Group justify="space-between">
              <Checkbox size="xs" label={
                <Text c="gray" size="xs">Remember me</Text>
              } />
          ...
          <Container w={"100%"}>
            <Button w={"100%"} variant="filled" onClick={() => navigate('/dashboard')}>Log In</Button>
          </Container>
        </Stack>
      </Center>
    </Container>
